...
snowPro.factory('ProCard', ['$resource', function( $resource ){
    return $resource('http://rest.thesnowpros.org/member/:verb', { verb:'@verb', callback: 'JSON_CALLBACK'}, {
        get: {method: 'JSONP'}
    });
}]);

snowPro.factory('Calendar', ['$resource', function( $resource ){
    return $resource('http://rest.thesnowpros.org/division/meetings', {callback: 'JSON_CALLBACK'}, {
        get: {method: 'JSONP'}
    });
}]);
